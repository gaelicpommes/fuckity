...
struct BeamlineHandles {
  ...
  // No explicit foils are used in the TOPAS-replica geometry.
  // These are kept only for compatibility with older code.
  G4double zFoil1  = 0.0;
  G4double zFoil4  = 0.0;
...
public:
  // Builds the TOPAS-replica beamline:
  //   source/eWindow reference plane
  //   -> imported TOPAS STL components:
  //      UnionAl, CAD4_bis, CAD6, CAD7, CAD11, CAD12,
  //      Applicateaur100mmx428mm
  //
  // No explicit 4 aluminium foils are built here because they do not appear as
  // separate geometry in the TOPAS input file.
  //
